...
<div class="result-grid">
    ...
    <div class="metric-card">
        ...
        <div class="metric-description">
            Прогнозируемая итоговая стоимость контракта считается на основе данных о начальной цене и предсказанном снижении. 
        </div>
    ...
    <div class="metric-card">
        ...
        <div class="metric-description">
            ${
                ...
                : "Признаков аномальногго снижения цены не выявлено"
            }
        </div>
...
<div class="result-footer">
    ...
    о торгах, параметров закупки и рыночных факторов. Результаты могут быть использованы как ориентир при принятии решения
